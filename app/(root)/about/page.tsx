        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="mb-8">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-300 text-sm font-medium mb-6">
              ...
              {currentLang === 'ar' ? 'منصة الذكاء الاصطناعي الرائدة' : 'Leading AI Platform'}
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-sm rounded-2xl p-10 border border-purple-500/30 max-w-3xl">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-white mb-3">Ahmed Alghamdi</h3>
                <p className="text-purple-400 font-medium text-xl mb-4">Founder & CEO</p>
              ...
              <div className="border-t border-purple-500/30 pt-6">
                <div className="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                  ...
                  <span className="text-zinc-300 text-lg">aalghamdi810@gmail.com</span>
                </div>
              </div>
            </div>
          </div>
