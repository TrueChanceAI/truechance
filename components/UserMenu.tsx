      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-zinc-900 rounded-lg shadow-xl border border-zinc-700 py-2 z-50 min-w-[200px] sm:min-w-[200px] max-w-[calc(100vw-2rem)] transform -translate-x-0 sm:translate-x-0">
          <div className="px-4 py-2 border-b border-zinc-700">
            <p className="text-sm font-medium text-white truncate">{user.given_name || 'User'}</p>
          ...
          <LogoutLink className="w-full text-left px-4 py-2 text-sm text-zinc-300 hover:bg-zinc-800 hover:text-white transition-colors flex items-center gap-2">
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
