...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const prodCsp = `
      ...
      connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://api.vapi.ai https://c.daily.co https://*.daily.co https://o77906.ingest.sentry.io;
